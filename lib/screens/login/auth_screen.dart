...
import 'widgets/login_choice.dart';
...
class _LoginState extends State<Login> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    // LoginRegisterBoolv2 loginOrRegister = Get.put(LoginRegisterBoolv2());
    RegistroLogin sx = Get.put(RegistroLogin());
    OlvidoContrasena recuperarContrasena = Get.put(OlvidoContrasena());
    return Scaffold(
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  const Spacer(),
                  // LoginOrRegister(_formElementAnimation),
                  Container(
                    ...
                    child: SingleChildScrollView(
                      child: LoginChoice(
                        ...
                        formElementAnimation: _formElementAnimation,
                      ),
                    ),
                  ),
                ],
...
class RegistroLogin extends GetxController {
  RxBool loginORegistro = true.obs; // our observable

  // swap true/false & save it to observable
  void toggle() => loginORegistro.value = loginORegistro.value ? false : true;
}

class OlvidoContrasena extends GetxController {
  RxBool olvidoContrasena = true.obs; // our observable

  // swap true/false & save it to observable
  void toggle() =>
      olvidoContrasena.value = olvidoContrasena.value ? false : true;
}
